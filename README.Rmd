...
autolegend <- gsplot() %>% 
  ...
  points(3:1, 3:1, col = "red", pch = 20, legend.name = "some other points") %>% 
...
Error bars        | blahblah  | blahblah  |
Callouts          | blahblah  | blahblah  |
Axes reversal     | If the axis needs to be reversed, you can add the argument `reverse = TRUE` to the function call. | 
