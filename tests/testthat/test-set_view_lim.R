# // JREAD comment: these tests didn't work (I pulled out xaxs and they didn't fail), and 
# it shouldn't be valid to set xlim that way because it isn't a par argument, right?
